...
export function Nav() {
  ...
  return (
    <div className="w-screen flex items-center justify-between border-gray-300 mt-4 mb-6 lg:justify-start lg:gap-12 ">
      <a href="/">
      ...
      <nav>
            ...
            <ul className="MENU-LINK-MOBILE-OPEN flex flex-col  ">
              ...
              <li>
                <div className="flex flex-col items-center">
                  ...
                  <button className="border-2 border-black px-16 py-2 rounded-xl">
                    Register
                  </button>
                </div>
              </li>
        ...
        <div className="">
          <ul className="DESKTOP-MENU hidden space-x-8 lg:flex lg:items-center lg:w-screen">
            <li className="">
              <button className="">
                <Drop />
              </button>
            ...
            <li className="lg:px-32 xl:px-52 ">
              
            </li>
            <div className="flex lg:flex-row lg:items-center lg:justify-center  ">
                <span className=" border-gray-400 mx-8 ">
                  <a href="/contact">Login</a>
                </span>
                <button className="border-2 border-black px-16 py-2 rounded-xl   lg:hover:bg-slate-300 lg:px-8 lg:py-2">
                  Register
                </button>
              </div>
          </ul>
